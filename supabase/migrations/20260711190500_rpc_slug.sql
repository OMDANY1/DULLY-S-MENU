-- DULLY'S MENU — CATEGORY SLUG MIGRATION
-- Reference Timestamp: 20260711190500

-- ==================================================
-- 01. ADD SLUG COLUMN TO MENU_CATEGORIES
-- ==================================================
ALTER TABLE public.menu_categories
ADD COLUMN IF NOT EXISTS slug TEXT;

-- Populate slug with id
...
-- ==================================================
-- 02. RECREATE get_public_menu() TO EXPLICITLY RETURN SLUG
-- ==================================================
