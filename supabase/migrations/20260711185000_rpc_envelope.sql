-- DULLY'S MENU — RPC ENVELOPE MIGRATION
-- Reference Timestamp: 20260711185000
--
-- Replaces flat-array get_public_menu() with a structured envelope:
-- { version, settings, categories }
--
-- Unpublished state returns: { version: 1, settings: {..., publicationStatus: "draft"}, categories: [] }
-- Published state returns:   { version: 1, settings: {..., publicationStatus: "published"}, categories: [...] }

-- ==================================================
-- 01. DROP AND RECREATE get_public_menu() WITH ENVELOPE
-- ==================================================
